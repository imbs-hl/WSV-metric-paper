...
plot_mse_0 <- ggplot(data = plot_data_1, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() +
  ylab("Relative prediction error of most representative tree") + xlab("Minimal node size") + ggtitle("Scenario 1: Few large main effects") +
  scale_fill_discrete(name = "Method") + 
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))

plot_mse_1 <- ggplot(data = plot_data_1, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() + 
  ylab("Relative prediction error of most representative tree") + xlab("Minimal node size") + ggtitle("Scenario 1: Few large main effects") + 
  theme(legend.position = "right") + scale_fill_discrete(name = "Method") + xlab("") + ylab("") +
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))

plot_mse_2 <- ggplot(data = plot_data_2, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() + 
  ylab("Relative prediction error of most representative tree") + xlab("Minimal node size") + ggtitle("Scenario 2: Many small main effects") + 
  theme(legend.position = "bottom") + scale_fill_discrete(name = "Method") + xlab("") + ylab("") + 
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))

plot_mse_3 <- ggplot(data = plot_data_3, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() + 
  ylab("Relative prediction error") + xlab("Minimal node size") + ggtitle("Scenario 3: Correlated variables") + 
  theme(legend.position = "bottom") + scale_fill_discrete(name = "Method") + xlab("") +   
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))

plot_mse_4 <- ggplot(data = plot_data_4, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() + 
  ylab("Relative prediction error of most representative tree") + xlab("Minimal node size") + ggtitle("Scenario 4: Interaction effects") + 
  theme(legend.position = "bottom") + scale_fill_discrete(name = "Method") + ylab("") + 
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))

plot_mse_5 <- ggplot(data = plot_data_5, aes(y = mse_val_dat_tree, fill = Metric, x = as.factor(min_node_size))) + geom_boxplot() + 
  ylab("Relative prediction error of most representative tree") + xlab("Minimal node size") + ggtitle("Scenario 5: Binary and continuous variables") + 
  theme(legend.position = "bottom") + scale_fill_discrete(name = "Method") + ylab("") +
  theme(legend.text = element_text(size=14), 
        legend.title = element_text(size=16),
        title = element_text(size=16))
...
plot_mse_val_dat <- grid.arrange(plot_mse_1 + theme(legend.position="none"),
...
ggsave(filename = "plot_mse_val_dat.pdf",
       plot     = plot_mse_val_dat,
       device   = "pdf",
       path     = out_dir,
       width    = 36,
       height   = 30,
